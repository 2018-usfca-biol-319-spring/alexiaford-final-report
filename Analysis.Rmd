...
This report will specifically be analyzing how the distribution of elevation varies across all NEON sites and species using box plots and geographical data.
...
```
2.2e-16 highly significant because  p < 0.001 tells me sites have different elevations
...
**Chi-square Test**
p-value < 2.2e-16
are significant differences in test results among sites
...
```
**Chi-square Test**
if its significant its found there are different species at different sites
