...
```{r boxplot-of-elevation-of-mosquito-pathogens-at-all-sites}
# elevation of NEON mosquitos pathogen data at all NEON sites 
ggplot(mos_pathogen_results, aes(x = siteID.testResult,
                    y = elevation)) +
  geom_boxplot() +
  ggtitle("Elevation of Mosquitos Pathogen Status at all NEON sites") +
  xlab("Site ID") +
  ylab("Elevation (meters)")
#r statistical test
anova(lm(elevation ~ siteID.testResult,
