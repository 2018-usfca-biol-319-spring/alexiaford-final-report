...
```{r read-in-data}
mos_pathogen_data <- read_csv("NEON_pathogens-mosquito/stackedFiles/mos_pathogenpooling.csv")
mos_pathogen_data <- read_csv("NEON_pathogens-mosquito/stackedFiles/mos_pathogenresults.csv")
count_mosquitoes_data <- read_csv("NEON_count-mosquitoes/stackedFiles/mos_expertTaxonomistIDProcessed.csv")
count_mosquitoes_data <- read_csv("NEON_count-mosquitoes/stackedFiles/mos_trapping.csv")
```
