...
Figure 5, test results of mosquito species across NEON sites, surveys species in relation to test results instead of elevation. The legend in Figure 5 exhibits a total of eight color coded scientific names. All eight names are found in the negative test results with varying
