...
ADD TEMPERATURE AND MOSQUITO PATHOGEN STATUS
...
Figure 4. Boxplot for STER site
```{r boxplot-for-STER-site}
# make a boxplot for the elevation of mosquitos at "STER" NEON site
...
mos_pathogen_results %>%
  ...
  ggtitle("Elevation of Mosquitos Species at STER NEON site") +
  xlab("Elevation (m)") +
  ylab("Count")
...
Figure 5. Boxplot for JERC site
```{r}

```

Figure 6. Map of the Elevation of Pathogen Results at all NEON Sites
...
Figure 7. Temperature across all NEON sites for Summer Months
...
Figure 8. Temperature across all NEON sites for Winter Months
